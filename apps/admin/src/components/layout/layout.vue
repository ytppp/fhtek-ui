<template>
  <div ref="layout" class="layout">
    <FhHeader ref="layoutHeader" :menus="menus" />
    <main class="layout__main" :style="!isMobile && { marginTop: `${layoutMainMarginTop}px` }">
      <template v-if="hasChildPage">
        <aside ref="layoutAside" class="layout__aside" :style="{ top: `${layoutAsideTop}px` }">
    ...
    <FhFooter v-if="isNoAuthPage" />
    <div v-if="!isNoAuthPage && menus.length <= toolbarMaxShowTotal" class="layout__toolbar-wrap">
    ...
    <fh-drawer v-if="isMobile" v-model:visible="drawer" size="90%" :append-to-body="true">
